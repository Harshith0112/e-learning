  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Learner outcomes on <b style={{ color: "#0056d2" }}>KL</b>
        </Text>
        <Text
          fontFamily={"poppins"}
          fontSize={{
